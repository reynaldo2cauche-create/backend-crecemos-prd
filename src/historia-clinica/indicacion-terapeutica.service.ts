    ...
    if (dto.materiales) {
      ...
      await this.materialesRepo.save(
        this.materialesRepo.create({
          ...
          guantes:                       m.guantes                       ?? false,
          bajalengua:                    m.bajalengua                    ?? false,
          hisoposPequenos:               m.hisoposPequenos               ?? false,
          hisoposLargos:                 m.hisoposLargos                 ?? false,
          plumonesGruesos:               m.plumonesGruesos               ?? false,
          cuadernoCuadriculado:          m.cuadernoCuadriculado          ?? false,
          cuadernoDecroly:               m.cuadernoDecroly               ?? false,
