...
//   // DESHABILITADO TEMPORALMENTE - Habilitar cuando esté todo configurado
//   // @Cron('0 8 * * *')
...
//       if (!config) {
//         this.logger.debug('Configuración de CUMPLEANOS_PACIENTE no encontrada o inactiva');
//         return;
//       }
...
//       if (!config) {
//         this.logger.debug('Configuración de ANIVERSARIO_EMPLEADO no encontrada o inactiva');
//         return;
//       }
